        ...
        ZStack {
            ...
            case .cameraPermission:
                PermissionRequestView(
                    ...
                    description: "Notch includes a mirror feature that lets you quickly check your appearance using your camera, right from the notch. Camera access is required only to show this live preview. You can turn the mirror feature on or off at any time in the app.",
            ...
            case .accessibilityPermission:
                PermissionRequestView(
                    ...
                    description: "Accessibility access is required to replace system notifications with the Notch HUD. This allows the app to intercept media and brightness events to display custom HUD overlays.",
